              ...
              <div className="modal-dialog" role="document">
                <div className="modal-content">
                  ...
                  <div className="modal-body">
                    <ul className="stars list-unstyled d-flex">
                      <li className="star mx-1">
                    ...
                    <button
                      className="btn my-3 float-right review-btn px-4 text-white btn-primary"
                      data-dismiss="modal"
                      aria-label="Close"
